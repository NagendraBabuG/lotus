...
# *** Modified: Updated source and refactored directory paths ***
SOURCE_DIR = 'C:/desktop/pqc/refactor/input/cryptome/excuted'
REF_OUT_DIR = 'C:/desktop/pqc/refactor/output/cryptome/excuted'
...
# *** Modified: Create mapping for source to multiple refactored files ***
file_mapping = {}
